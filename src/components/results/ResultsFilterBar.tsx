...
export default function ResultsFilterBar({
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
      <select value={session} onChange={(e) => update({ session: e.target.value, term: '' })} className={inputClass}>
      ...
      <select value={classId} onChange={(e) => update({ class: e.target.value, subject: '' })} className={inputClass}>
